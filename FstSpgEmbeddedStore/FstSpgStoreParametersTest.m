...
#import "FstSpgStoreParametersTest.h"


@implementation FstSpgStoreParametersTest

- (void) setUp
{
	params = [[FstSpgStoreParameters parameters] retain];
}
...
{
	[params setStoreId:@"storeId" withProductId:@"productId"];
	[params setMode:kFstSpgModeTest];
...
{
	[params setOrderProcessType:kFstSpgOrderProcessInstant];
	[params setStoreId:@"storeId" withProductId:@"productId"];
