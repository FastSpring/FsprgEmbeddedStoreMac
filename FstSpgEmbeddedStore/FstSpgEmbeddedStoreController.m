//
//  FstSpgEmbeddedStoreController.m
//  FstSpgEmbeddedStore
//
...
#import "FstSpgOrderView.h"
#import "FstSpgOrderDocumentRepresentation.h"


@implementation FstSpgEmbeddedStoreController

+ (void)initialize
{
	[WebView registerViewClass:[FstSpgOrderView class]
		   representationClass:[FstSpgOrderDocumentRepresentation class]
...
{
	if(delegate == nil) {
		NSLog(@"No delegate has been assigned to FstSpgEmbeddedStoreController!");
	}
